...
class CreateStudyRequestView extends StatelessWidget {
  const CreateStudyRequestView({super.key});
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        buildCard(
                          child: Column(
                            children: [
                              ...
                              customText(
                                text: "Find your perfect study partner",
                        ...
                        _buildInputField(
                          label: "Your Goal",
                          child: _buildTextContainer("eg Q/A practice"),
                        ),
                        verticalSpacer(height: 16),

                        // Field 3: Your Availability
                        _buildInputField(
                          label: "Your Availability",
                          child: _buildTextContainer("8:00 pm"),
                        ),
